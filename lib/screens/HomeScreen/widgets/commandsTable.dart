...
class CommandsActionTable extends StatelessWidget {
  const CommandsActionTable({
    Key? key,
    required this.data,
  }) : super(key: key);

  final List<CommandsTableData> data; // List of CommandsActionTable action data
                        ...
                        Padding(
                          ...
                          child: Row(
                            children: [
                              ...
                              IconButton(
                                icon: const Icon(Icons.person, color: ColorManager.primary),
                                onPressed: () {
  ...
  // For Clipboard
  void _showUserInfoDialog(CommandsTableData user) {
    Get.dialog(
      AlertDialog(
        ...
        content: Column(
          ...
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            _buildCopyableText('Name: ${user.name}', user.name),
            _buildCopyableText('Email: ${user.email}', user.email),
            _buildCopyableText('Phone: ${user.phone}', user.phone),
          ],
        ),
        actions: [
          TextButton(
